...
# -*- coding: utf-8 -*-
#
# PennyLane-Forest documentation build configuration file.
#
...
release = pennylane_qsharp.__version__
...
htmlhelp_basename = 'PennyLane-QSharpdoc'
...
html_theme_options = {
    ...
    "project_nav_name": "PennyLane-Qsharp",
...
latex_documents = [
    (master_doc, 'PennyLane-qsharp.tex', 'PennyLane-Q# Documentation',
     'Xanadu Inc.', 'manual'),
]
...
man_pages = [
    (master_doc, 'pennylane-qsharp', 'PennyLane-Q# Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc,
     'PennyLane-Q#',
     'PennyLane-Q# Documentation',
     author,
     'PennyLane-Q#',
     'Q# plugin for the PennyLane quantum machine learning library.',
     'Miscellaneous'),
]
